...
def test_cannot_find_a_connections_if_stations_do_not_exist():
...
def test_cannot_find_a_connections_if_stations_are_unreacheable():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
...
def test_train_status_in_empty_if_no_train_exist():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
    t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
...
def test_get_empty_purchase_history_if_user_not_registered():
     rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
     t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
     user_email = "user@email.org"
...
def test_delete_user():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
    t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
    # Register this only user in the database
    user_email = "user@email.org"
    user_details = None
    t.add_user(user_email, user_details)
    utils = TraitsUtility(rdbms_connection, rdbms_admin_connection, neo4j_driver)
...
def test_cannot_add_duplicated_train():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
    t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
    train_key = TraitsKey(1)
    train_capacity = 100
...
def test_delete_a_nonexisting_train_should_not_fail():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
    t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
...
def test_do_not_connect_train_stations_with_wrong_travel_time():
    """
    Connect to train station so trains can travel on them
    Raise ValueError if any of the stations does not exist
    Raise ValueError for invalid travel_times
...
def test_do_not_add_schedule_if_stops_are_not_connected():
    rdbms_connection, rdbms_admin_connection, neo4j_driver = None, None, None
    t = Traits(rdbms_connection, rdbms_admin_connection, neo4j_driver)
    # Add two stations
    starting_train_station_key = TraitsKey(1)
